                                    ...
                                    <div class="card">
                                        <div class="card-body" style="height: 100px">
                                          <div class="row">
                                            ...
                                            <form action="{{ url('/pay-benefit') }}" method="POST" class="needs-validation">
                                                        <input type="hidden" name="email"
                                                            value="{{auth('customer')->user()->email}}"> {{-- required --}}
                                                        <input type="hidden" name="name"
                                                            value="{{auth('customer')->user()->f_name}} {{auth('customer')->user()->l_name}}"> {{-- required --}}
                                                        <input type="hidden" name="mobile"
                                                            value="{{auth('customer')->user()->phone}}"> {{-- required --}}
                                                        <input type="hidden" name="address"
                                                            value=" {{auth('customer')->user()->house_no}} {{auth('customer')->user()->street_address}} {{auth('customer')->user()->city}} {{auth('customer')->user()->zip}} {{auth('customer')->user()->country}}"> {{-- required --}}
                                                        <input type="hidden" name="orderID"
                                                            value="{{session('cart_group_id')}}">
                                                        <input type="hidden" name="amount"
                                                            value="{{\App\CPU\Convert::usdTobhd($amount)}}"> {{-- required in kobo --}}
                                                ...
                                                <button class="btn btn-block click-if-alone" type="submit">
                                                    <img width="50"
                                                        src="{{asset('public/assets/front-end/img/benefit.png')}}"/>
                                                </button>
                                            </form>
                                        </div>
                                    </div>
                           ...
                           @php($config=\App\CPU\Helpers::get_business_settings('credimax'))
                            @if($config['status'])
                                <div class="col-md-6 mb-4" style="cursor: pointer">
                                    <div class="card">
                                        <div class="card-body" style="height: 100px">
                                            <form action="{{ url('/pay-credimax') }}" method="POST" class="needs-validation">
                                                <input type="hidden" value="{{ csrf_token() }}" name="_token"/>
                                                <div class="row">
                                                    <div class="col-md-8 col-md-offset-2">
                                                        <input type="hidden" name="email"
                                                ...
                                                <button class="btn btn-block click-if-alone" type="submit">
                                                    <img width="170"
                                                        src="{{asset('public/assets/front-end/img/credimax.jpg')}}"/>
                                                </button>
                                            </form>
                                        </div>
                                    </div>
