...
use App\Http\Controllers\plugin\KeyStore;
use App\Http\Controllers\plugin\parseResource;


class iPayBenefitPipe extends Controller
{
    protected $id = "";
    protected $action = "";
    protected $transId = "";
    ...
    public function getAuthRespCode()
    {
    ...
    public function setAuthRespCode($val)
    {
...
//$this->webAddress="http://10.44.73.173:8080/FSSNET_BENEFIT";
    ...
    public function encryptAESold($str, $key)
    {
...
//done for 32 length key
    ...
    public function byteArray2Hexold($byteArray)
    {
...
//for 24 bit length key
    public function decryptDataold($code, $key)
    {
...
//for 32 bit length key
    ...
    public function performTranPortalTransactionsslKeystore($request, $webAddress, $filePath, $password)
    {
        $webAddress = $webAddress . "/tranPipe.htm?param=tranInit";
        $response = "";
        $tranType = "tran";
