...
class WebController extends Controller
{
    ...
    public function checkout_complete(Request $request,$method='cash_on_delivery',$trn_id='')
    {
        ...
        if(session()->has('transaction_detail')){
        session()->forget('transaction_detail');
        }
