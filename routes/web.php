...
Route::group(['namespace' => 'Web','middleware'=>['maintenance_mode']], function () {
    ...
    Route::group(['middleware'=>['customer']], function () {
        ...
        Route::any('checkout-payment', 'WebController@checkout_payment')->name('checkout-payment')->middleware('customer');
        Route::get('checkout-review', 'WebController@checkout_review')->name('checkout-review')->middleware('customer');
        Route::any('checkout-complete/{method?}/{trn_id?}', 'WebController@checkout_complete')->name('checkout-complete')->middleware('customer');
...
/*benefit*/
Route::post('pay-benefit', [BenefitPaymentController::class, 'request'])->name('pg.request');
// Route::post('pay-benefit', 'BenefitPaymentController@payWithbenefit');
/*benefit*/
