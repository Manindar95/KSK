...
// Route::any('/benefit-error', 'BenefitPaymentController@payment_error');

Route::post('/pg/response', [BenefitPaymentController::class, 'response'])->name('pg.response');
Route::any('/pg/approved', [BenefitPaymentController::class, 'approved'])->name('pg.approved');
Route::any('/pg/declined', [BenefitPaymentController::class, 'declined'])->name('pg.declined');
Route::any('/pg/error', [BenefitPaymentController::class, 'error'])->name('pg.error');
Route::any('/credimax-error', 'credimaxPaymentController@payment_error');
