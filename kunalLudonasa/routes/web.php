...
/*benefit*/
Route::any('pay-benefit', 'BenefitPaymentController@payWithbenefit');
Route::get('benefit-status', 'BenefitPaymentController@getPaymentStatus')->name('paypal-status');
Route::get('benefit-success', 'BenefitPaymentController@success')->name('paypal-success');
Route::get('benefit-fail', 'BenefitPaymentController@fail')->name('paypal-fail');
/*benefit*/
/*Recovery*/
Route::get('clean/recovery', function(){
    Artisan::call('cache:clear');
    Artisan::call('route:clear');
    return dd("Recovered Successfully");
});
/*credimax*/
Route::any('pay-credimax', 'credimaxPaymentController@pay');
Route::get('credimax-out', 'credimaxPaymentController@out');
Route::get('credimax-in', 'credimaxPaymentController@in');
Route::get('credimax-fail', 'credimaxPaymentController@fail')->name('paypal-fail');
/*credimax*/
...
Route::get('/controller', function (){
    //Artisan::call('make:controller plugin/parseResource');
});