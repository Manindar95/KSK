    ...
    <div class="content container-fluid">
        ...
        <div class="row" style="padding-bottom: 20px">
            ...
            <div class="col-md-6 mt-4">
                <div class="card">
                    <div class="card-body" style="padding: 20px">
                        <h5 class="text-center">{{\App\CPU\translate('Benefit')}}</h5>
                        @php($config=\App\CPU\Helpers::get_business_settings('benefit'))
                        <form action="{{route('admin.business-settings.payment-method.update',['benefit'])}}"
                              method="post">
                            @csrf
                            @if(isset($config))
                                <div class="form-group mb-2">
                                    <label class="control-label">{{\App\CPU\translate('Benefit')}}</label>
                                </div>
                                <div class="form-group mb-2 mt-2">
                                    <input type="radio" name="status" value="1" {{$config['status']==1?'checked':''}}>
                                    <label style="padding-left: 10px">{{\App\CPU\translate('Active')}}</label>
                                ...
                                <div class="form-group mb-2">
                                    <label
                                        style="padding-left: 10px">{{\App\CPU\translate('merchant_id')}}</label><br>
                                    <input type="text" class="form-control" name="merchant_id"
                                           value="{{env('APP_MODE')=='demo'?'':$config['merchant_id']}}">
                                </div>
                                <div class="form-group mb-2">
                                    <label style="padding-left: 10px">{{\App\CPU\translate('user_id')}}</label><br>
                                    <input type="text" class="form-control" name="user_id"
                                           value="{{env('APP_MODE')=='demo'?'':$config['user_id']}}">
                                </div>
                                <div class="form-group mb-2">
                                    <label style="padding-left: 10px">{{\App\CPU\translate('user_password')}}</label><br>
                                    <input type="text" class="form-control" name="user_password"
                                           value="{{env('APP_MODE')=='demo'?'':$config['user_password']}}">
                                </div>
                                <button type="{{env('APP_MODE')!='demo'?'submit':'button'}}"
                                        onclick="{{env('APP_MODE')!='demo'?'':'call_demo()'}}"
                                        class="btn btn-primary mb-2 float-right">{{\App\CPU\translate('save')}}</button>
          ...
          <div class="col-md-6 mt-4">
                <div class="card">
                    <div class="card-body" style="padding: 20px">
                        <h5 class="text-center">{{\App\CPU\translate('credimax')}}</h5>
                        @php($config=\App\CPU\Helpers::get_business_settings('credimax'))
                        <form action="{{route('admin.business-settings.payment-method.update',['credimax'])}}"
                              method="post">
                            @csrf
                            @if(isset($config))
                                <div class="form-group mb-2">
                                    <label class="control-label">{{\App\CPU\translate('credimax')}}</label>
                                </div>
                                <div class="form-group mb-2 mt-2">
                                    <input type="radio" name="status" value="1" {{$config['status']==1?'checked':''}}>
                                    <label style="padding-left: 10px">{{\App\CPU\translate('Active')}}</label>
                                ...
                                <div class="form-group mb-2">
                                    <label style="padding-left: 10px">{{\App\CPU\translate('operator_id')}}</label><br>
                                    <input type="text" class="form-control" name="operator_id"
                                           value="{{env('APP_MODE')=='demo'?'':$config['operator_id']}}">
                                </div>
                                <div class="form-group mb-2">
                                    <label style="padding-left: 10px">{{\App\CPU\translate('operator_password')}}</label><br>
                                    <input type="text" class="form-control" name="operator_password"
                                           value="{{env('APP_MODE')=='demo'?'':$config['operator_password']}}">
                                </div>
                                <button type="{{env('APP_MODE')!='demo'?'submit':'button'}}"
                                        onclick="{{env('APP_MODE')!='demo'?'':'call_demo()'}}"
                                        class="btn btn-primary mb-2 float-right">{{\App\CPU\translate('save')}}</button>
